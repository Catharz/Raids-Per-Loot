Feature: Manage drops
  ...
  Background: Need to login, and have some valid data
  ...
  Scenario: Drop with an invalid zone name should not be saved
    Given I am on the new drop page
    When I fill in "Zone name" with "The Fridge"
    And I fill in "Mob name" with "mob_name 1"
    And I fill in "Player name" with "player_name 1"
    And I fill in "Item name" with "item_name 1"
    And I fill in "Eq2 item" with "eq2_item_id 1"
    And I select "09/18/2011 20:15:00" as the "Drop time" date and time
    And I press "Create"
    Then I should see "A valid zone must exist to be able to create drops for it"
    And I should not see "Drop was successfully created"

  Scenario: Drop with an invalid mob name should not be saved
    Given I am on the new drop page
    When I fill in "Zone name" with "zone_name 1"
    And I fill in "Mob name" with "Pizza"
    And I fill in "Player name" with "player_name 1"
    And I fill in "Item name" with "item_name 1"
    And I fill in "Eq2 item" with "eq2_item_id 1"
    And I select "09/18/2011 20:15:00" as the "Drop time" date and time
  ...
  Scenario: Drop with an invalid player name should not be saved
    Given I am on the new drop page
    When I fill in "Zone name" with "zone_name 1"
    And I fill in "Mob name" with "mob_name 1"
    And I fill in "Player name" with "Me"
    And I fill in "Item name" with "item_name 1"
    And I fill in "Eq2 item" with "eq2_item_id 1"
    And I select "09/18/2011 20:15:00" as the "Drop time" date and time
    And I press "Create"
    Then I should see "A valid player must exist to be able to create drops for them"
    And I should not see "Drop was successfully created"

  Scenario: Drop with an invalid item name should not be saved
    Given I am on the new drop page
    When I fill in "Zone name" with "zone_name 1"
    And I fill in "Mob name" with "mob_name 1"
    And I fill in "Player name" with "player_name 1"
    And I fill in "Item name" with "Can of Whoop Ass"
    And I fill in "Eq2 item" with "eq2_item_id 1"
    And I select "09/18/2011 20:15:00" as the "Drop time" date and time
    And I press "Create"
  ...
  Scenario: Drop with an invalid drop time should not be saved
    Given I am on the new drop page
    When I fill in "Zone name" with "zone_name 1"
    And I fill in "Mob name" with "mob_name 1"
    And I fill in "Player name" with "Me"
    And I fill in "Item name" with "item_name 1"
    And I fill in "Eq2 item" with "eq2_item_id 1"
    And I select "12/31/2011 23:59:00" as the "Drop time" date and time
    And I press "Create"
