  ...
  describe 'PUT update' do
    ...
    describe 'with valid params' do
      it 'located the requested @comment' do
        put :update, id: @comment, comment: FactoryGirl.attributes_for(:comment, commented_id: @player.id)
        assigns(:comment).should eq (@comment)
      end

      it 'updates the requested comment' do
        Comment.any_instance.should_receive(:update_attributes).with({ 'comment_date' => '2013-07-16' })
        put :update, id: @comment, comment: { 'comment_date' => '2013-07-16' }
      end
