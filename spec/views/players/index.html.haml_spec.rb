...
describe 'players/index.html.haml' do
  ...
  before(:each) do
    ...
    scout_player = stub_model(Player, name: 'Scout Main',
                              rank_id: main_rank.id)
    fighter_player = stub_model(Player, name: 'Fighter Main',
                                rank_id: main_rank.id)
    priest_player = stub_model(Player, name: 'Priest Alternate',
                               rank_id: main_rank.id)
    mage_player = stub_model(Player, name: 'Mage Alternate',
                             rank_id: main_rank.id)
