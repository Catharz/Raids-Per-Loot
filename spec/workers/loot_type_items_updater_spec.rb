  ...
  describe '#perform' do
    describe 'updates items to that loot type' do
      it 'sets the drop loot_method to trash if the loot type is trash' do
        trash_drop = FactoryGirl.create(:drop, loot_method: 'n', loot_type: trash_loot_type)
      ...
      it 'sets the drop loot_method to guild bank if the loot type is guild bank' do
        bank_drop = FactoryGirl.create(:drop, loot_method: 'n', loot_type: bank_loot_type)
      ...
      it 'sets the loot_type of trash drops to trash if not already set' do
        trash_item = FactoryGirl.create(:item, :name => 'Trash Item', loot_type: trash_loot_type)
        trash_drop = FactoryGirl.create(:drop, loot_method: 'n', item: trash_item, loot_type: bank_loot_type)
      ...
      it 'sets the loot_type of bank drops to bank if not already set' do
        bank_item = FactoryGirl.create(:item, :name => 'Bank Item', loot_type: bank_loot_type)
        bank_drop = FactoryGirl.create(:drop, :loot_method => 'n', item: bank_item, loot_type: trash_loot_type)
