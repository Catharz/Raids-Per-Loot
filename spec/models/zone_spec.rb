...
describe Zone do
  describe 'progression' do
    context 'should be Yes' do
      it 'if raided less than 10 times and normal or lower difficulty' do
    ...
    context 'should be No' do
      it 'if the zone is easy' do
      ...
      it 'if we have run it more than 20 times' do
        hard = FactoryGirl.create(:difficulty, name: 'Hard', rating: 3)
        zone = FactoryGirl.create(:zone, name: 'Hard Zone', difficulty: hard)
