...
describe Adjustment do
  ...
  describe 'self#for_period' do
    let(:adj1) { FactoryGirl.create(:adjustment, adjustable: @fred, adjustment_date: Date.today - 60.days,
                                    reason: 'Whatever', amount: 6) }
    let(:adj2) { FactoryGirl.create(:adjustment, adjustable: @fred, adjustment_date: Date.today - 30.days,
                                    reason: 'Some Other Reason', amount: 3) }
    let(:adj3) { FactoryGirl.create(:adjustment, adjustable: @barny, adjustment_date: Date.today,
                                    reason: 'Testing', amount: 1) }
  ...
  describe 'self.for_character' do
    it 'should filter by character_id' do
      adj1 = FactoryGirl.create(:adjustment, adjustable: @fred, reason: 'Whatever', amount: 6)
      adj2 = FactoryGirl.create(:adjustment, adjustable: @fred, reason: 'Some Other Reason', amount: 3)
      adj3 = FactoryGirl.create(:adjustment, adjustable: @barny, reason: 'Testing', amount: 1)
  ...
  describe 'self.for_player' do
    it 'should filter by player_id' do
      adj1 = FactoryGirl.create(:adjustment, adjustable: @betty, reason: 'Whatever', amount: 3)
      adj2 = FactoryGirl.create(:adjustment, adjustable: @betty, reason: 'Some Other Reason', amount: 2)
      adj3 = FactoryGirl.create(:adjustment, adjustable: @wilma, reason: 'Testing', amount: 1)
  ...
  describe 'self.by_adjustable_type' do
    it 'should filter by adjustable type' do
      adj1 = FactoryGirl.create(:adjustment, adjustable: @fred)
      adj2 = FactoryGirl.create(:adjustment, adjustable: @fred)
      adj3 = FactoryGirl.create(:adjustment, adjustable: @barny)
      adj4 = FactoryGirl.create(:adjustment, adjustable: @betty)
      adj5 = FactoryGirl.create(:adjustment, adjustable: @betty)
      adj6 = FactoryGirl.create(:adjustment, adjustable: @wilma)
  ...
  describe 'self.by_adjustment_type' do
    it 'should filter by adjustment type' do
      adj1 = FactoryGirl.create(:adjustment, adjustable: @fred, adjustment_type: 'Raids')
      adj2 = FactoryGirl.create(:adjustment, adjustable: @fred, adjustment_type: 'Instances')
      adj3 = FactoryGirl.create(:adjustment, adjustable: @barny, adjustment_type: 'Raids')
      adj4 = FactoryGirl.create(:adjustment, adjustable: @betty, adjustment_type: 'Instances')
      adj5 = FactoryGirl.create(:adjustment, adjustable: @betty, adjustment_type: 'Raids')
      adj6 = FactoryGirl.create(:adjustment, adjustable: @wilma, adjustment_type: 'Instances')
  ...
  describe 'name' do
    ...
    it 'returns the player name for a player adjustment' do
      adj1 = FactoryGirl.create(:adjustment, adjustable: @betty, adjustment_type: 'Instances')
